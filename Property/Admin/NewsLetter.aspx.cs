    ...
    public partial class NewsLetter : System.Web.UI.Page
    {
        ...
        protected void FillGridData()
       {
        ...
        public string SendNewsLetter(NewsLetterModel model)
        {
            ...
            {
                model.Logopath = "http://mujahidasahedirealtor.com/images/logo.png";
            }
           

            if (model.PropertyPhoto  == null || model.PropertyPhoto == "")
            {
                model.PropertyPhoto = "http://mujahidasahedirealtor.com/images/img1.png";
            }
        ...
        public void Firstnewsletter(NewsLetterModel Model)
        {
            ...
            //else
            //{
            //    Model.Logopath = "..http://mujahidasahedirealtor.com/images/MyLogodd%20-%20Copy.png";
            //}
            Model.AdminPhoto = "http://mujahidasahedirealtor.com/images/ajay_shah.jpg";
