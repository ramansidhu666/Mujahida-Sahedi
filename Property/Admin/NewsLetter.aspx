                        ...
                        <div style="float: left; width: 99%; background-color: #231f20; border-bottom: 8px solid #eda320; padding: 6px 0;">
                            ...
                            <div style="float: left; width: 67%; padding: 6px;">
                                ...
                                <div style="float: left; width: 100%; margin: 12px 0 0;">
                                    <h2 style="float: left; width: 100%; font-size: 18px; font-family: Arial, Helvetica, sans-serif; color: #FFF; margin: 0px;">Mujahida Sahedi</h2>
                                    ...
                                    <p style="float: left; width: 100%; margin: 0">
                                        ...
                                        <span style="float: left; font-size: 14px; color: #FFF; margin: 0 10px 0 4px;">416-457-5524</span>
                                        <span style="float: left; font-size: 15px; color: #c48820; margin: 0 6px 0 1px">Email:</span>
                                        <span style="float: left; font-size: 14px; color: #FFF;">mujahidas@hotmail.com</span>
                                    </p>
                                    <p style="float: left; width: 100%; margin: 0">
                                    ...
                                    <p style="float: left; width: 100%; font-size: 22px; font-family: Arial, Helvetica, sans-serif; color: #c48820; margin: 5px 0 0;">www.mujahidasahedirealtor.com</p>
                                </div>
                            </div>
                        </div>
